    ...
    <div class="frame-parent">
        ...
        <div class="frame-wrapper9">
            <div class="frame-parent3">
                <div class="trang-ch-parent">
                    ...
                    <div class="qun-l-sn">Thêm người dùng</div>
                </div>
                <div class="thm-ngi-dng-parent">
                    <div class="thm-ngi-dng">Thêm người dùng</div>
        ...
        <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="frame-parent5">
                        <div class="frame-parent6">
                            <div class="tn-parent">
                                ...
                                <input type="text" name="userName" class="email-wrapper" placeholder="Tên">
                            </div>
                            <div class="tn-parent">
                                <div class="to-sn-phm">Chức vụ</div>
                                <input type="text" name="role" class="email-wrapper" placeholder="Chức vụ">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Id user</div>
                            <div class="instance-wrapper">
                                <input type="text" name="userID" class="email-frame" placeholder="ID user">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Email</div>
                            <div class="instance-wrapper">
                                <input type="text" name="email" class="email-frame" placeholder="Email">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Password</div>
                            <div class="instance-wrapper">
                                <input type="text" name="password" class="email-frame" placeholder="Password">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Số điện thoại</div>
                            <div class="instance-wrapper">
                                <input type="text" name="phone" class="email-frame" placeholder="Số điện thoại">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Địa chỉ</div>
                            <div class="instance-wrapper">
                                <input type="text" name="address" class="email-frame" placeholder="Địa chỉ">
                            </div>
                        </div>
                    </div>
            ...
            <div class="ti-nh-ln-container">
                <input type="submit" name="add_user" value="Gửi">
            </div>
        </form>
    </div>
</body>
