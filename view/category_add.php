        ...
        <div class="frame-wrapper9">
            <div class="frame-parent3">
                <div class="trang-ch-parent">
                    ...
                    <div class="qun-l-sn">Thêm danh mục</div>
                </div>
                <div class="thm-ngi-dng-parent">
                    <div class="thm-ngi-dng">Thêm danh mục</div>
                </div>
            </div>
        </div>
                    ...
                    <div class="frame-parent5">
                        <div class="frame-parent6">
                            <div class="tn-parent">
                                ...
                                <input type="text" name="categoryID" class="email-wrapper" placeholder="Mã danh mục">
                            </div>
                            <div class="tn-parent">
                                <div class="to-sn-phm">Tên danh mục</div>
                                <input type="text" name="name" class="email-wrapper" placeholder="Tên danh mục">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="ti-nh-ln-container">
                    <input type="submit" name="add_category" value="Gửi" style="top: 100px; left: 20px;">
                </div>
        </form>
    </div>
</body>
