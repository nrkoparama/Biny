    ...
    <div class="frame-parent">
        ...
        <div class="frame-wrapper9">
            <div class="frame-parent3">
                <div class="trang-ch-parent">
                    ...
                    <div class="qun-l-sn">Quản lý sản phẩm</div>
                </div>

                <div class="thm-ngi-dng-parent">
                    <div class="thm-ngi-dng">Thêm sản phẩm</div>
                </div>
            </div>
        </div>
        <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="frame-parent5">
                        <div class="frame-parent6">
                            <div class="tn-parent">
                                ...
                                <input type="text" name="categoryID" class="email-wrapper" placeholder="Danh Mục">
                            </div>
                            <div class="tn-parent">
                                <div class="to-sn-phm">Mã Brand</div>
                                <input type="text" name="brandID" class="email-wrapper" placeholder="Mã Brand">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Tên sản phẩm</div>
                            <div class="instance-wrapper">
                                <input type="text" name="name" class="email-frame" placeholder="Tên sản phẩm">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Giá</div>
                            <div class="instance-wrapper">
                                <input type="text" name="price" class="email-frame" placeholder="Giá">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Số lượng</div>
                            <div class="instance-wrapper">
                                <input type="text" name="stock" class="email-frame" placeholder="Số lượng">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Mô tả</div>
                            <div class="instance-wrapper" >
                                <input type="text" name="description" style="height:100px;" class="email-frame" placeholder="Mô tả">
                            </div>
                        </div>
                    </div>
                    <div class="frame-parent7">
                        <img id="preview" class="frame-child" alt="Preview" src="" />
            ...
            <div class="ti-nh-ln-container">
                <input type="submit" name="add_product" value="Gửi">
            </div>
        </form>
    </div>
</body>
