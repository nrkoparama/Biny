<?php
$html_product_detail_left = '';
   extract($productdetail);
   $html_product_detail_left.='
   <div class="product__big__images">
       <div class="portfolio-full-image tab-content">
           <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
               <img src="view/assets/images/trueimg/'.$img.'" alt="full-image">
           </div>
       </div>
   </div>';
   ...
   $html_product_detail_right='';
    extract($productdetail);
   $html_product_detail_right.='
   <div class="ht__product__dtl">

   <h2>'.$name.'</h2>
   <h6>Brand: <span>Teelab</span></h6>
   ...
   <div class="ht__pro__desc">
       ...
       <form action="index.php?pg=addcart" method="post">
        <button type="submit" name="addcart" class="addToCart" >Add to cart</button>
                    ...
                    <div class="product__wrap clearfix">
                            ...
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="product-details.html">
                                        <img src="view/assets/images/trueimg/sp1.webp" alt="product images">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="product-details.html">
                                        <img src="view/assets/images/trueimg/sp2.webp" alt="product images">
                                    </a>
                                </div>
                                <div class="fr__hover__info">
                                    <ul class="product__action">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="product-details.html">
                                        <img src="view/assets/images/trueimg/sp3.webp" alt="product images">
                                    </a>
                                </div>
                                <div class="fr__hover__info">
                                    <ul class="product__action">
