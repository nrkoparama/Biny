    ...
    <div class="frame-parent">
        <div class="frame-group">
            ...
            <div class="instance-group">
                ...
                <div class="frame-div">
                    <div class="sn-phm-wrapper">
                        <a href="?pg=actegory-admin&act=add">
        ...
        <div class="frame-wrapper9">
            <div class="frame-parent3">
                <div class="trang-ch-parent">
                    ...
                    <div class="qun-l-sn">Chỉnh sửa sản phẩm</div>
                </div>
                <div class="thm-ngi-dng-parent">
                    <div class="thm-ngi-dng" style="width:300px">Chỉnh sửa sản phẩm</div>
        ...
        <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="frame-parent4">
                    <div class="frame-parent5">
                        <div class="frame-parent6">
                            <div class="tn-parent">
                                <div class="to-sn-phm">Danh Mục</div>
                                <input type="text" name="categoryID" class="email-wrapper" value="<?=$sp['categoryID']?>">
                            </div>
                            <div class="tn-parent">
                                <div class="to-sn-phm">Mã Brand</div>
                                <input type="text" name="brandID" class="email-wrapper" value="<?=$sp['brandID']?>">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Tên sản phẩm</div>
                            <div class="instance-wrapper">
                                <input type="text" name="productID" class="email-frame" value="<?=$sp['productID']?>">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Tên sản phẩm</div>
                            <div class="instance-wrapper">
                                <input type="text" name="name" class="email-frame" value="<?=$sp['name']?>">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Giá</div>
                            <div class="instance-wrapper">
                                <input type="text" name="price" class="email-frame" value="<?=$sp['price']?>">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Số lượng</div>
                            <div class="instance-wrapper">
                                <input type="hiden" name="stock" class="email-frame" value="<?=$sp['stock']?>">
                            </div>
                        </div>
                        <div class="tn-parent">
                            <div class="to-sn-phm">Mô tả</div>
                            <div class="instance-wrapper" >
                                <input type="text" name="description" style="height:100px;" class="email-frame" value="<?=$sp['description']?>">
                            </div>
                        </div>
                    </div>
                    <div class="frame-parent7">
                        <img id="preview" class="frame-child" alt="Preview" src="img/<?=$sp['img']?>" />
            ...
            <div class="ti-nh-ln-container">
                <input type="submit" name="edit_product" value="Gửi" style="top:550px">
            </div>
        </form>
    </div>
</body>
